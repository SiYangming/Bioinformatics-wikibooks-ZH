...
#The request ID is <input name="RID" size="50" type="text" value="1008521553-19248-17370"><p></p>

#<input name="RID" type="hidden" value="1008521553-19248-17370"><input name="RTOE" type="hidden" value="4"><input name="CLIENT" type="hidden" value="Legacy"><input name="FORMAT_OBJECT" type="hidden" value="Alignment"><input name="CMD" type="hidden" value="Get"><input name="PAGE" type="hidden" value=""><input name="FORMAT_PAGE_TARGET" type="hidden" value=""><input name="RESULTS_PAGE_TARGET" type="hidden" value=""><input name="LAYOUT" type="hidden" value="TwoWindows"><input name="FORMAT_BLOCK_ON_RESPAGE" type="hidden" value=""><input name="STEP_NUMBER" type="hidden" value="1"><input name="EXPECT" type="hidden" value="10"><input name="HITLIST_SIZE" type="hidden" value="100"><input name="DESCRIPTIONS" type="hidden" value="100"><input name="ALIGNMENTS" type="hidden" value="100"><input name="AUTO_FORMAT" type="hidden" value="SemiAuto"><p></p>

#    RID = 1008521553-19248-17370
